...
<head>
    <meta charset="UTF-8">
    <title>Produk - Dapurku Store</title>
...
<header>🍳 Dapurku Store – Katalog Alat Dapur</header>
...
?>
    <div class="card">
        ...
        <?php if (!empty($p['image'])): ?>
            <img src="uploads/<?= htmlspecialchars($p['image']); ?>" alt="Produk">
        <?php else: ?>
        ...
        <div class="card-body">
            ...
            <a class="btn-detail" href="product_detail.php?id=<?= $p['id']; ?>">
                Detail Produk
            </a>
        </div>
